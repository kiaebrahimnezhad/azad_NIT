    ...
    return (
        <div className={containerClasses}>
            ...
            <div className="p-6 border-b border-slate-700/50">
                <div className="flex items-center space-x-3">
                    ...
                    <div className='flex gap-2 items-center'>
                        ...
                        <p className="text-xs text-gray-400">ادمین سیستم</p>
                    </div>
                </div>
            </div>

            {/* Navigation Menu */}
            <nav className="p-4" role="navigation" aria-label="منوی پنل مدیریت">
                <ul role="menu" className="space-y-1">
                    {menuItems.map((item) =>
                        renderMenuItem(item, activePanel === item.key, () => {
            ...
            <div className="bottom-0 left-0 right-0 p-4 border-t border-slate-700/50 bg-slate-900/50">
                ...
                >
                    <svg className="w-5 h-5 ml-3 transition-transform duration-200 group-hover:scale-110"
                    ...
                    {/* Hover effect overlay */}
                    <div className=" bg-red-500/5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
                </button>
            </div>
        </div>
    );
