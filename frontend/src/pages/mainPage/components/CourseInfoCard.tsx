    ...
    <section className="bg-white shadow-xl rounded-xl overflow-hidden">
      <div className="md:flex">
        ...
        <div className="md:w-2/3 p-8 space-y-4">
          ...
          <button
            className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:to-blue-800 text-white py-3 rounded-lg shadow-md mt-6 disabled:from-gray-300 disabled:to-gray-300 disabled:cursor-not-allowed"
            onClick={onAddToBasket}
            disabled={!course.is_valid}
          >
            {course.is_valid ? "افزودن به سبد خرید" : "این دوره غیرفعال است"}
          </button>
        </div>
      </div>
    </section>
